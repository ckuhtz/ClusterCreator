...
%{ if is_control_plane == true }
  ...
  extraManifests:
    ...
    - https://github.com/kubernetes-sigs/metrics-server/releases/download/v${cluster_config.metrics_server.metrics_server_version}/high-availability-1.21+.yaml # HA metrics-server
%{ endif }
---
apiVersion: v1alpha1
